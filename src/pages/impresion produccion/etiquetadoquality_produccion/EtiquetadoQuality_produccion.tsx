...
const EtiquetadoQuality_produccion: React.FC = () => {
  ...
  const handleConfirmEtiqueta = () => {
    ...
    const maquina = filteredMaquinas.find(
      (m) => m.id === selectedMaquina
    )?.maquina;
    ...
    const requiredFields = [
      ...
      { name: "Fecha", value: data.fecha },
      {
        ...
        value: data.postExtraQuality.individualUnits,
      },
      {
        name: "Item Description",
        value: data.postExtraQuality.itemDescription,
      },
      ...
      <Box className="impresion-card-destiny">
        ...
        <Box className="impresion-form-destiny">
          ...
          <TextField
            ...
            value={lot}
            onChange={(e) =>
              setLot(Math.max(0, parseFloat(e.target.value) || 0))
            }
            inputProps={{
          ...
          <TextField
            ...
            value={qtyUOM || ""}
            onChange={(e) =>
              setQtyUOM(Math.max(0, parseFloat(e.target.value) || 0))
            }
            inputProps={{ min: 0 }}
          />
          <TextField
            ...
            onChange={(e) =>
              setTotalQtyPallet(Math.max(0, parseFloat(e.target.value) || 0))
            }
            inputProps={{
              min: 0,
            }}
      ...
      >
        <Paper className="quality-modal-content">
          ...
          <Box className="quality-modal-body">
            ...
            <div className="row">
              <Typography>
                <strong>Total Qty/Pallet:</strong>
              </Typography>
              <Typography>{totalQtyPallet}</Typography>
            </div>
            <div className="row">
              <Typography>
                <strong>Traceability Code:</strong>
              </Typography>
